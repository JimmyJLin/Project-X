...
INSERT INTO Applicants (user_id,first_name,last_name,desired_industry,desired_location,skills,school,education_level, experience_level,certifications,languages_spoken, resume_pdf, profile_image ) VALUES
...
('3','jimmy','Lin','{"finance"}','{"New York", "New Jersey", "London"}','{"html","JS","Ruby"}','Pace University','MBA','2 Years','{"CPA", "CFA", "PFS"}', '{"TURKISH", "ENGLISH", "CHINESE"}', 'EMINEKOC.PDF', 'images/img_placeholders/150x150.jpg');
