...
class Matched_employer_profile extends Component {
  ...
  componentDidMount() {
    ...
    $.get('http://localhost:8080/api/jobs/active/1').done( (data)=>{
     ...
     $.get('http://localhost:8080/api/jobs/archived/1').done( (data)=>{
   ...
   $.get('http://localhost:8080/api/employers/1').done( (data)=>{
