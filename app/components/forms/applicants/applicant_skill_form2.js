...
class Applicant_skill_form_backup_ex extends Component {
  ...
  handleSubmitData(e){
    ...
    postExperienceData(experienceData);
    postSkillsData(skillsData);
  }
  ...
  render(){
    ...
    //             <option className="item" name="entry" onClick={ `this.handle${industry.value}EntryChange.bind(this)`}> 0-2 years Entry Level</option>
    //             <option className="item" name="mid" onClick={`this.handle${industry.value}MidChange.bind(this)`}> 2-5 years Mid Level</option>
    //             <option className="item" name="high" onClick={ `this.handle${industry.value}HighChange.bind(this)`}> 5+ years</option>
    //           </div>
    //         </div>
    // })
...
function postExperienceData(data){
