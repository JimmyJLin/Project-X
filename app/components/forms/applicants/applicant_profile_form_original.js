...
class Applicant_profile_form_original extends Component {
  ...
  render(){
    ...
    const applicantForm = (
        <div id="Applicant_profile_form_original">
          <br/>
          <br/>
          <h1> Tell Us About Yourself, and We'll Tell YOu Who's Looking to Hire You</h1>

          <form className="ui form Applicant_profile_form_original" onSubmit={this.handleSubmit.bind(this)}>
...
export default connect(mapStateToProps)(Applicant_profile_form_original);
