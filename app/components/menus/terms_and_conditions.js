            ...
            <ol start="1">
              <li> Definitions
                <ol type="a">
                  ...
                  <li> In this Agreement, unless the context require otherwise:
                    <ol type="i">
                    <li>masculine, feminine or neuter gender references respectively includes the other genders and any reference to the singular includes the plural (and vice versa);</li>
              ...
              <li>In addition to terms elsewhere defined in this Agreement and unless differently provided hereby, the following terms and expressions shall have the following meanings:
                <ol type="a">
                  ...
                  <li>“AtlasCV”, “us”, “we”, “our(s)” shall refer to our company, AtlasCV, our Site and our Service</li>
                  ...
                  <li>“Contractor Offer” shall refer to an offer of employment as a contractor, for either an indefinite or fixed term (each, a “Contractor Engagement”)</li>
                  <li>“Covered Offer” shall refer to an Job Offer made by an employer during or within twelve (12) months after termination of a Contractor Engagement with such employer;</li>
                  ...
                  <li>“Job Acceptance Form” shall refer to a notification signed by the employer and the candidate, stating that the candidate accepted a Job Offer, including details of engagement and scope of role, remuneration and conditions of employment</li>
                </ol>
              </li>
              ...
              <li> AtlasCV holds the right:
                <ol type="a">
                  <li>to request further clarification regarding uploaded information, before approving any given user of the Service. In doing this, we reserve the right to use a third party service such as Github, LinkedIn or Twitter to validate your information and / or confirm your registration</li>
              ...
              <li> In agreeing to use our Service, both candidates and employers agree and undertake:
                <ol type="a">
                  <li>a)	that no Active Recruiting Process (defined as continuous direct, back and forth communication, in an active recruiting or hiring context where a decision to put a candidate on hold or reject has not been made) has been in place between the employer and the candidate for the 90 days prior to the beginning of the Engagement;</li>
                  <li>that they shall carry on the Engagement by using exclusively our Site. Further communication may take place outside of our Site after the Invitation is sent out and accepted</li>
                  <li>to promptly inform us if a Job Offer is signed, providing us with either a Job Acceptance Form or a signed Job Offer by both parties</li>
                </ol>
              </li>
              ...
              <li>1)	You will not upload invalid or illegal data, viruses, worms or other software agents through the Service.</li>
              <li>You will not collect and make inappropriate use of any personally identifiable information, including account names, from the Service. You will also not use our Site to post false or fraudulent information about a company or individual</li>
              <li>You will not engage in any form of commercial activity by using Content acquired by accessing our Service. Similarly, you will not engage in any commercial activity linked to giving access to third parties to your Service access</li>
              ...
              <li>Dispute Resolution
                <ol type="a">
                  <li>All disputes between AtlasCV and you arising out of or in relation to this Agreement (including any disputes related to the validity, interpretation or enforceability of this arbitration clause) shall be settled by arbitration under the rules of the State of New York (the “Arbitration Rules”). The arbitral tribunal will consist of 3 (three) arbitrators, regardless of the number of the Parties involved, appointed in accordance with the Arbitration Rules. The Parties agree that, in case each Party appoints its arbitrator, the chairman of the panel will be appointed by the two party-appointed arbitrators. The award may be always challenged for breach of the substantial provisions applicable to the merit of the dispute</li>
